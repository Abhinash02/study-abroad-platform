      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-4 py-8 sm:px-6 sm:py-10 lg:px-10">
          <div className="w-full max-w-xl">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-soft sm:p-6 md:p-8">
              <div className="mb-8">
              ...
              <div className="my-6 flex items-center gap-4">
                ...
                <span className="text-center text-xs font-medium uppercase tracking-[0.2em] text-slate-400">
                  Account access
                </span>
                <div className="h-px flex-1 bg-slate-200" />
              </div>
